...
export default function EmployeeRecordsPage({ params }: { params: Promise<{ id: string }> }) {
    const { id } = use(params)
    ...
    const fetchEmployeeData = async () => {
        try {
            ...
            const emp = empData.find((e: Employee) => e.employee_id === id)
            if (!emp) {
    ...
    const kpiCards = [
        { label: 'Total Days', value: totalDaysMarked, color: 'blue' as const, icon: '📅' },
        { label: 'Present', value: totalPresent, color: 'green' as const, icon: '✓' },
        { label: 'Absent', value: totalAbsent, color: 'red' as const, icon: '✗' },
    ]
            ...
            <header className="bg-white shadow-sm">
                <div className="max-w-4xl mx-auto px-4 py-4 lg:py-6">
                    <div className="flex items-center justify-between">
                        ...
                        <Link href="/employees" className="text-sm lg:text-base text-blue-600 hover:text-blue-800 ml-4 whitespace-nowrap">
                            ← Back
                        </Link>
                    </div>
                </div>
            ...
            <div className="max-w-4xl mx-auto px-4 py-4 lg:py-8">
                ...
                {error && !loading && (
                    <div className="text-center py-8">
                        ...
                        <Link href="/employees" className="px-4 py-2 bg-gray-100 text-gray-700 rounded hover:bg-gray-200">
                            Back to Employees
                        </Link>
                    </div>
                )}
