                ...
                <Card className="p-4 lg:p-6 mb-6 lg:mb-8">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            />
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Or Add Custom</label>
                                ...
                                {useCustomDept && <p className="text-xs text-blue-600 mt-1">Using custom department</p>}
                            </div>
                        </div>
                                ...
                                {employees.map((emp) => (
                                    <div key={emp.id} className="p-4">
                                        ...
                                        <div className="flex gap-4">
                                            <Link href={`/employees/${emp.employee_id}`} className="text-sm text-blue-600 hover:text-blue-800">
                                                View Details
                                            </Link>
                                            <button onClick={() => handleDelete(emp.employee_id)} className="text-sm text-red-600 hover:text                                                Delete
                                           -red-800">
 </button>
                                        </div>
                                    </div>
                                        ...
                                        {employees.map((emp) => (
                                            <tr key={emp.id} className="hover:bg-gray-50">
                                                ...
                                                <td className="px-6 py-4 text-sm space-x-3">
                                                    <Link href={`/employees/${emp.employee_id}`} className="text-blue-600 hover:text-blue-800">View</Link>
                                                    <button onClick={() => handleDelete(emp.employee_id)} className="text-red-600 hover:text-red-800">Delete</button>
                                                </td>
                                            </tr>
                                        ))}
                                    </tbody>
